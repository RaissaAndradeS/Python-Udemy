...
que retornam outras funções como resultado ou mesmo passar funções como argumentos
para outras funções, e até mesmo criar variáveis do tipo de funçõs nos nossos programas

OBS: No programa funções, utilizamos isso
...
# Nesred Functions - Funções Aninhadas
...
def faz_me_rir():
    def rir():
        return choice(('haahahahahah', 'kkkkkkkkkk', 'yaayayayayayyaa'))
    return rir
...
def faz_me_rir_novamente(pessoa):
    def dando_risada():
        risada = choice(('hahahaahha', 'lolololo', 'kkkkkkkkkkk'))
