"""
Funçôes com Parâmetro Padrão (Default Paramters)
...
# OBS: Se o usuário passar somente 1 argumento, este será atribuído ao parâmetro numero, e será calculado o quadrado deste número;
# Se o usuário passar 2 argumentos, o primeiro será atribuído ao parâmentro número e o segundo ao parâmetro potência, então
...
def diz_oi():
    instrutor='Python'   # Variavel Local -> se sobrepõe a variável Global
    return f'Oi {instrutor}'
...
# print(dentro())  NameError, não é reconhecida, tá dentro da função fora