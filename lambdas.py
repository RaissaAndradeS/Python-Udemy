...
Conhecidas por Expressões Lambdas, ou Lambdas, são funções sem nome, ou funções anônimas
...
# n = lambda x1, x1, ..., nx: <expressão>
# Obs: se passar mais argumentos do que parâmetros, da TypeError
