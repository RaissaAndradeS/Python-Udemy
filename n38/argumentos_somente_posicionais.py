...
# print(cumprimenta_v2(nome='Geek'))  erro
...
# print(cumprimenta_v4('University', mensagem='Hello')) erro

"""
# são obrigatórios com *
...
# print(cumprimentar_v6('Geek', 'oi', 'vamos?'))  # Erro
