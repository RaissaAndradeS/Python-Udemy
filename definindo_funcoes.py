...
Obs: Se você escrever uma função que realiza várias tarefas dentro dela é bom fazer
uma verificação para que a função seja simplificada.

Já utilizamos várias funções desed que iniciamos esse curso:
...
definindo uma função. Também abrimos o blaco de código com o já conhecido dois pontos : que é utilizado em Python para 
definir blocos.
"""
...
1 - Veja que dentro das nossas funções podemos utilizae outras funções;
2 - Veja que nossa função só executa 1 taref, ou seja, a única coisa que ela faz é dizer oi;
