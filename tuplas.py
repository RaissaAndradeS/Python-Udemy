...
2 - As tuplas são imutávies: isso significa que ao se criar uma tupla ela não muda. toda operação em uma nova tupla gera uma nova tupla.
"""
...
# Podemos gerar uma tupla dinamicamente com range (inicio, fim
...
# Soma*, Valo Máximo, Valor Mínimo* e Tamanho
...
# Obs: caso o elemento não exista, será derado erro (ValueError)
